  ...
  data () {
    const dataList = [
      ...
      },
      {
        date: `2021/6/22`,
        value: [
          `BFC 用来清除浮动  防止mergin重叠，自适应多栏布局`,
          `$route.matched  返回该页面所在路由`,
        ],
      ...
      },
      {
        date: `2021/7/12`,
        value: [
          `TypeScript=>类型断言.  使用as来告诉编译器这个变量就是某一个属性，使用as any可以调用所有属性`,
          `页面截图`,
        ],
      ...
      },
      {
        date: `2021/7/27`,
        value: [
          `nuxt->asyncData()，页面渲染之前将请求获取的内容渲染到html上`,
